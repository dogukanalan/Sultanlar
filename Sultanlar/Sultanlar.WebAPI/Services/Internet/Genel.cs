...
namespace Sultanlar.WebAPI.Services.Internet
{
    ...
    {
        internal static double IskontoDus(double fiyat, double isk1, double isk2, double isk3, double isk4, double isk5)
        {
        ...
        internal static double KdvEkle(double fiyat, double kdv)
        {
