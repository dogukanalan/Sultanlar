...
{
    public class Kural : Defaults
    {

    }

    public class KuralSiparisDis : Kural
    {
        public KuralSiparisDis()
        {
            LoadDefaults();
        }
        ...
        [XmlElement(ElementName = "TRADING_GRP"), DefaultValue("01")]
        ...
        public List<KuralSiparisDisDispatch> DISPATCHES { get; set; }

        public List<KuralSiparisDisDetay> TRANSACTIONS { get; set; }

        public List<KuralSiparisDisPayment> PAYMENT_LIST { get; set; }
        ...
        public List<KuralSiparisDisIntel> INTEL_LIST { get; set; }
        ...
        public List<KuralSiparisDisOkcInfo> OKCINFO_LIST { get; set; }
    ...
    [XmlType("TRANSACTION")]
    public class KuralSiparisDisDetay : Kural
    {
        public KuralSiparisDisDetay()
        {
            LoadDefaults();
        }
        ...
        public List<KuralSiparisDisCmpInfo> CAMPAIGN_INFOS { get; set; }
    ...
    [XmlType("DISPATCH")]
    public class KuralSiparisDisDispatch : Kural
    {
        public KuralSiparisDisDispatch()
        {
            LoadDefaults();
        }
    ...
    [XmlType("PAYMENT")]
    public class KuralSiparisDisPayment : Kural
    {
        public KuralSiparisDisPayment()
        {
            LoadDefaults();
        }
        ...
        [XmlElement(ElementName = "DAYS"), DefaultValue("30")]
    ...
    [XmlType("INTEL")]
    public class KuralSiparisDisIntel : Kural
    {
        public KuralSiparisDisIntel()
        {
            LoadDefaults();
        }
    ...
    [XmlType("OKCINFO")]
    public class KuralSiparisDisOkcInfo : Kural
    {
        public KuralSiparisDisOkcInfo()
        {
            LoadDefaults();
        }
    ...
    public class KuralSiparisDisCmpInfo : Kural
    {
        public KuralSiparisDisCmpInfo()
        {
            LoadDefaults();
        }
    }
    ...
    public class KuralFaturalarDis
    {
        [XmlElement(ElementName = "INVOICE", Order = 1)]
        public List<KuralSiparisDis> Faturalar { get; set; }
    }
}
