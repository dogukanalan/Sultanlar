<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kutuphane2.aspx.cs" Inherits="Sultanlar.WebUI.merch.kutuphane2" %>
                ...
                <uc2:ucUst ID="ucUst" runat="server" />
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width: 20%"><a href='download.aspx?kutupid=<%#Eval("pkID").ToString()%>&kac=2&tur=<%#Eval("strDosyaTur").ToString()%>&ad=<%#Eval("strAd").ToString().Replace(" ", "_")%>' class="button">indir</a></td>
                        </tr>
                    </ItemTemplate>
