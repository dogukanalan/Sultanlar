<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="siparislersap.aspx.cs" Inherits="Sultanlar.WebUI.musteri.siparislersap" %>
...
<head runat="server">
    ...
    <title>Sultanlar : Sistemdeki Siparişler</title>
    ...
    <table cellpadding="0" cellspacing="0" style="width: 1000px; height: 400px; font-size: 10px; font-family: Verdana;
        ...
        <tr>
            ...
            <div class="Baslik">
                ...
                <td style="width: 100%">Sistemdeki Siparişler<asp:Label runat="server" Width="30px"></asp:Label><input style="font-size: 10px; font-style: italic" type="button" value="Siparişler" onclick="javascript:window.location.href='siparisler.aspx'" /><input style="font-size: 10px; font-style: italic" type="button" value="Sistemdeki Siparişler Detayı" onclick="javascript:window.location.href='siparislersapdetay.aspx'" /></td>
                </tr>
                </table>
                ...
                SelectCommand="SELECT [Vbeln] AS [Sip.No],[Erdat] AS [Tarih],[OName1] AS [Ana Cari],[Name1] AS [Cari],[Vtext2] AS [Bölüm]/*,[Comm Text] AS [Fat.Tip],[Pltyp] AS [Fiy.Tip]*/,[Sip Aciklama] AS [Açıklama],[Burut] AS [Brüt],[Isk] AS [İsk.],[Net] AS [Net],[Koli] FROM [SAP_SIPARIS_BASLIK] WHERE YEAR(Erdat) = 2017 AND [Sipalan Kod] = @SLSREF ORDER BY Erdat DESC">
                <SelectParameters>
