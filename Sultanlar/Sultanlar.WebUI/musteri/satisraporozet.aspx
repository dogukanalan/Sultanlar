<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="satisraporozet.aspx.cs" Inherits="Sultanlar.WebUI.musteri.satisraporozet" %>
...
<head id="Head1" runat="server">
    <title>Sultanlar : Satış Rapor Özet</title>
    ...
    <table cellpadding="0" cellspacing="0" style="width: 1000px; height: 400px; font-size: 10px; font-family: Verdana;
        ...
        <tr>
            ...
            <div class="Baslik">
                ...
                <td style="width: 100%">Satış Rapor Özeti<asp:Label runat="server" Width="30px"></asp:Label><input style="font-size: 10px; font-style: italic" type="button" value="Geri Dön" onclick="javascript:window.location.href='satisrapor.aspx'" /></td>
                </tr>
                </table>
                ...
                SelectCommand="SELECT * FROM [zWeb-Satis-Rapor-Ozet] WHERE SATICI_KOD = @SLSREF">
                <SelectParameters>
