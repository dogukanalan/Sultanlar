<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aktivite.aspx.cs" Inherits="Sultanlar.WebUI.musteri.aktivite" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #FFFFFF">
    ...
    <div id="tiptip_arrow_inner"></div>
            ...
            <div style="position: absolute; width: 300px; height: 500px; z-index: 3; left: 235px;
                top: 325px;" runat="server" id="divKategori" visible="false">
            ...
            <div style="position: absolute; width: 300px; height: 500px; z-index: 2; left: 560px;
                top: 260px;" runat="server" id="divTedarikci" visible="false">
            ...
            <div runat="server" id="divSepetBuyut" style="position: absolute; width: 60px; height: 50px; 
                z-index: 0; left: 40px; top: 285px; padding: 2px; font-family: Tahoma; font-size: 10px">
            ...
            <div style="position: absolute; width: 300px; height: 100px; z-index: 4; left: 320px;
                ...
                <td align="center" valign="middle">
                    Girilen ürünleri listeye aktarmadınız. Devam etmek istiyor musunuz?<br /><br />
            ...
            <div style="position: fixed; width: 100%; height: 100%; z-index: -1; left: 0; top: 0;
                ...
                <tr>
                <td align="center" valign="middle">
                    Aktivite iptal edilecek, devam etmek istiyor musunuz?<br /><br />
            ...
            <div style="position: absolute; width: 300px; height: 100px; z-index: 4; left: 320px;
                ...
                <tr>
                <td align="center" valign="middle">
                    Bir aktiviteye en fazla 100 kalem ürün girebilirsiniz. Ürün eklemek için yeni bir aktivite açıp devam edebilirsiniz.<br /><br />
            ...
            <input type="hidden" runat="server" id="inputDonemYil" />
            <input type="hidden" runat="server" id="inputDonemAy" />
            <div style="position: absolute; width: 300px; height: 100px; z-index: 5; left: 320px;
                top: 231px;" runat="server" id="divDonem" visible="false">
            <div style="position: fixed; width: 100%; height: 100%; z-index: -1; left: 0; top: 0;
                filter: alpha(opacity=60); -moz-opacity: .60; opacity: .60; background-color: #000000">
            </div>
                <table style="width: 100%; height: 100%; background-color: #ffffff; font-family: Tahoma; font-size: 12px;
                ...
                <tr>
                <td align="center" valign="middle">
                    <span style="color: Red; font-weight: bold">Fiyatlar İçin Dönem Seçiniz</span>
                    <br /><br />
                    ...
                    <br /><br />
                    <asp:Button runat="server" ID="btnDonemTamam" Text="Tamam" Width="80px" OnClick="btnDonemTamam_Click" 
                        BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" ForeColor="#6D8AAA" />
                </td>
                </tr>
                </table>
            ...
            <div style="position: absolute; width: 300px; height: 100px; z-index: 5; left: 320px;
                top: 231px;" runat="server" id="divAnlasmaSecim" visible="false">
            <div style="position: fixed; width: 100%; height: 100%; z-index: -1; left: 0; top: 0;
                filter: alpha(opacity=60); -moz-opacity: .60; opacity: .60; background-color: #000000">
            </div>
                <table style="width: 100%; height: 100%; background-color: #ffffff; font-family: Tahoma; font-size: 12px;
                ...
                <tr>
                <td align="center" valign="middle">
                    <span style="color: Red; font-weight: bold">Anlaşma Seçiniz</span>
                    <br /><br />
                    <asp:RadioButtonList ID="rblAnlasmalar" runat="server"></asp:RadioButtonList>
                    <br /><br />
                    <asp:Button runat="server" ID="btnAnlasmaTamam" Text="Tamam" Width="80px" OnClick="btnAnlasmaTamam_Click" 
                        BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" ForeColor="#6D8AAA" />
                </td>
                </tr>
                </table>
            ...
            <div style="position: absolute; width: 980px; z-index: 3; left: 3px;
                top: 10px;" runat="server" id="divSepet" visible="false">
            <div style="width: 100%; height: 100%; background-color: #ffffff; border: 1px solid #D1D1D1; border-radius: 5px; padding: 5px; margin-bottom: 20px;">
                ...
                <asp:Button Width="90px" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" Font-Size="9px" ID="btnSiparisiIptalEt" runat="server" Text="Akt.İptal Et" OnClick="btnSiparisiIptalEt_Click" ForeColor="Red" />
                <asp:Label ID="Label3" runat="server" Width="1px"></asp:Label>
                <asp:Button Width="120px" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" Font-Size="9px" ID="btnSepetiBosalt" runat="server" Text="Akt.Listesini Boşalt" OnClick="btnSepetiBosalt_Click" ForeColor="Red" />
                <asp:Label ID="Label4" runat="server" Width="1px"></asp:Label>
                <asp:Button Width="120px" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" Font-Size="9px" ID="btnSepetKapat" runat="server" Text="Akt.Devam Et" OnClick="lbSepetKapat_Click" />
                </td>
                        ...
                        <table width="960px" cellpadding="3" cellspacing="0" style="font-family: Tahoma; font-size: 11px">
                            <tr style="color: #C00000">
                                ...
                                <td align="center" style="width: 100px; font-size:12px">
                                    <asp:CheckBox Visible="false" runat="server" ID="cbSepetSecimTumu" AutoPostBack="true" OnCheckedChanged="cbSepetSecimTumu_OnCheckedChanged" />
                    ...
                    <ItemTemplate>
                        <tr style="background-color: #E8E8E8">
                            ...
                            <td align="left" style="width: 100px">
                                <input type="hidden" value='<%#Eval("AktiviteDetayID") %>' id="AktiviteDetayID" runat="server" />
                                <input type="hidden" value='<%#Eval("UrunID") %>' id="UrunID" runat="server" />
                                <%--<asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="true" OnCheckedChanged="SepetUrunSecim_Click" />
                            ...
                            <td align="center" style="width: 40px;">
                                <%#Convert.ToDouble(Eval("FatAltIsk")).ToString("N1")%>
                            </td>
                            <td align="center" style="width: 40px;">
                                <%#Convert.ToDouble(Eval("FatAltCiro")).ToString("N1")%>
                            </td>
                            <td align="center" style="width: 40px;">
                            ...
                            <td align="right" style="width: 60px;">
                                <input type="hidden" value='<%#Eval("BirimFiyatKDVli")%>' id="BirimFiyatKDVli" runat="server" />
                                <%#Convert.ToDecimal(Eval("BirimFiyatKDVli")).ToString("N3")%> TL
                            </td>
                            <td align="right" style="width: 80px;">
                                <input id="AksiyonFiyati" type="text" runat="server" value='<%#Convert.ToDecimal(Eval("AksiyonFiyati")).ToString("N3")%>'
                                    style="width: 75px; color: #006699; border: 1px solid #A3B5C9; text-align: center" />
                            </td>
                            <td align="center" style="width: 60px;">
                                ...
                                <input id="SatisHedefi" type="text" runat="server" value='<%#Eval("SatisHedefi")%>' onkeypress="return isNumberKey(event)"
                                    style="width: 35px; color: #006699; border: 1px solid #A3B5C9; text-align: center" />
                            ...
                            <td align="center" style="width: 60px;">
                                <input id="EkIsk" type="text" runat="server" value='<%#Convert.ToDouble(Eval("EkIsk")).ToString("N2")%>'
                                    style="width: 55px; color: #006699; border: 1px solid #A3B5C9; text-align: center" />
                            </td>
                            <td align="center" style="width: 50px;">
                                <input id="EkIskFiyat" type="text" runat="server" value='<%#Convert.ToDecimal(Eval("DusulmusBirimFiyatKDVli")).ToString("N3")%>'
                                    style="width: 55px; color: #006699; border: 1px solid #A3B5C9; text-align: center" />
                            </td>
                            <td align="right" style="width: 60px;">
                                <span class="kucukbilgiGoster" title='Son Giden Fiyat: <%#Convert.ToDecimal(Eval("SonFiyat")).ToString("C3")%>'>
                    ...
                    <AlternatingItemTemplate>
                        <tr style="background-color: #FFE2C6">
                            ...
                            <td style="width: 100px">
                                <input type="hidden" value='<%#Eval("AktiviteDetayID") %>' id="AktiviteDetayID" runat="server" />
                                <input type="hidden" value='<%#Eval("UrunID") %>' id="UrunID" runat="server" />
                                <%--<asp:CheckBox ID="CheckBox2" runat="server" AutoPostBack="true" OnCheckedChanged="SepetUrunSecim_Click" />
                                <asp:Label ID="Label9" runat="server" Width="5px"></asp:Label>
                                &nbsp;--%>
                                <%--<span class="hotspot" onmouseover="tooltip.show('<%#Eval("Brutler") %>');" onmouseout="tooltip.hide();">--%>
                                <%#Eval("UrunAdi") %>
                                <%--</span>--%>
                            </td>
                            <td align="center" style="width: 40px;">
                ...
                <table cellpadding="10" cellspacing="0" style="font-family: Tahoma; font-size:12px; width: 980px; height: 40px">
                <tr>
                ...
                <td align="left" valign="middle">
                    ...
                    <asp:Button Width="90px" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" ForeColor="#6D8AAA" Font-Size="9px" runat="server" ID="btnSiparisiTamamla" onclick="btnSiparisiTamamla_Click" Text="Akt.Kaydet"></asp:Button>
                    <asp:Label ID="Label13" runat="server" Width="1px"></asp:Label>
                    <asp:Button Width="130px" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" ForeColor="#6D8AAA" Font-Size="9px"  runat="server" ID="btnSiparisiTamamlaOnayla" onclick="btnSiparisiTamamlaOnayla_Click" Text="Akt.Kaydet ve Onay Talep Et"></asp:Button>
                    <asp:Label ID="Label14" runat="server" Width="20px"></asp:Label>
                    <asp:Label runat="server" ID="lblOrtalamaVade"></asp:Label>
                </td>
                <td align="right" valign="middle">Akt.Toplamı: </td>
                </tr>
                </table>
                </td>
            ...
            <table cellpadding="0" cellspacing="0" style="width: 900px; height: 500px; background-color: #FFFFFF;
                ...
                <tr>
                    ...
                    <table style="font-family: Verdana; font-size: 11px; color: #D00000"><tr>
                        ...
                        <td style="width: 50px; text-align: center;">Vade</td>
                        ...
                        <td style="width: 170px; text-align: center; font-size: 12px; color: #000000">
                            Adet:
                            <asp:Label ID="Label16" runat="server" Width="20px"></asp:Label>
                ...
                <tr>
                    <td align="center">
                    <table style="font-family: Verdana; font-size: 11px; display: none; visibility: collapse"><tr>
                        ...
                        <td style="width: 50px; text-align: center"><asp:Label runat="server" ID="lblUrunAyrintiVade"></asp:Label></td>
                        ...
                        <td style="width: 170px; text-align: center">
                            <asp:Button runat="server" ID="btnUrunAyrintiSiparisVer" Text="Listeye Aktar" 
            ...
            <div style="width: 1000px; text-align: right; font-size: 10px; font-family: Verdana">
                        <asp:Button ID="btnOneri" runat="server" BorderColor="#FFA968" BackColor="#FFE7D8"
                            BorderStyle="Solid" BorderWidth="1px" ForeColor="#EE7A0B" Font-Bold="true"
                            style="position: absolute; z-index: 1; left: 5; top: 20;"
                            onclick="btnOneri_Click" Text="Öneri" Width="100px" />
            <table cellpadding="0" cellspacing="0" style="width: 1000px; margin-top: 5px;">
                <tr>
                    <td style="width: 430px; text-align: left; padding-left: 10px; font-size: 10px">
                        <asp:Label ID="lblBayi" runat="server" style="color: #D00000"></asp:Label><br />
                        <asp:Label ID="lblCariHesap" runat="server" style="color: #D00000"></asp:Label></td>
                    <td style="width: 570px; text-align: left; font-size: 10px">
                        <table style="width: 100%"><tr><td style="width: 285px" align="right">
                        Akt.Baş.Tarihi: <input type="text" id="datepicker1" runat="server" onkeypress="return yazma(event)" autocomplete="off" /></td><td align="right">
                        Akt.Bit.Tarihi: <input type="text" id="datepicker2" runat="server" onkeypress="return yazma(event)" autocomplete="off" />
                        </td></tr></table>
                    </td>
                </tr>
                <tr>
                    <td style="width: 430px; text-align: left; padding-left: 10px; font-size: 10px"></td>
                    <td style="width: 570px; text-align: left; font-size: 10px">
                        <table style="width: 100%"><tr><td style="width: 285px" align="right">
                        An.Baş.Tarihi: <input type="text" id="inputAnlasmaBaslangic" runat="server" onkeypress="return yazma(event)" disabled="disabled" /></td><td align="right">
                        An.Bit.Tarihi: <input type="text" id="inputAnlasmaBitis" runat="server" onkeypress="return yazma(event)" disabled="disabled" />
                        </td></tr></table>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 570px; text-align: left; font-size: 10px">
                        <table style="width: 100%"><tr><td style="width: 285px" align="right">
                        KGT Bed.Top.: <input type="text" id="inputTAHSabitBedel" runat="server" onkeypress="return yazma(event)" disabled="disabled" /></td><td align="right">
                        NF Bed.Top.: <input type="text" id="inputYEGSabitBedel" runat="server" onkeypress="return yazma(event)" disabled="disabled" />
                        </td></tr></table>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 570px; text-align: left; font-size: 10px">
                        <table style="width: 100%"><tr><td style="width: 285px" align="right">
                        KGT Hed.Ciro: <input type="text" id="inputTAHHedefCiro" runat="server" onkeypress="return yazma(event)" disabled="disabled" /></td><td align="right">
                        NF Hed.Ciro: <input type="text" id="inputYEGHedefCiro" runat="server" onkeypress="return yazma(event)" disabled="disabled" />
                        </td></tr></table>
                    </td>
                </tr>
                <tr>
                            ...
                            <tr>
                                <td style="width: 256px; text-align: left">
                                    <%--<asp:DropDownList ID="ddlFiyatTipleri" runat="server" AutoPostBack="True" 
                                                    ...
                                                    Width="180px" ForeColor="#006699" Visible="false"
                                                    style="padding: 3px 3px 3px 3px;border:1px solid #CCCCCC;background:#ededed;"
            ...
            <table runat="server" id="tblURUNLER" cellpadding="0" cellspacing="0" style="width: 1000px; font-family: Tahoma;
                ...
                <tr>
                    <td colspan="2" style="height: 110px; padding-bottom: 6px;" valign="bottom">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="left" rowspan="2" style="padding: 5px; padding-left: 10px; width: 460px;">
                                    <fieldset style="border: 1px solid #CCCCCC; width: 450px; margin: 0px 10px 0px 10px; border-radius: 5px; padding: 5px;">
                                    ...
                                    <tr>
                                        ...
                                        <tr>
                                        <td>
                                            <asp:RadioButton ID="rbBarkodaGore" runat="server" AutoPostBack="true" Visible="false" 
                                                GroupName="grpArama" Text="" OnCheckedChanged="rbAramaSecimleri_CheckedChanged" />
                                        </td>
                                        <td style="padding-left: 5px">
                                            <asp:CheckBox ID="cbBarkodHemenAra" runat="server" AutoPostBack="true" Visible="false" Checked="false"
                                                Text="" OnCheckedChanged="cbBarkodHemenAra_CheckedChanged" />
                                        </td>
                                        <td style="padding-left: 5px">
                                            <asp:CheckBox ID="cbBarkodHemenEkle" runat="server" AutoPostBack="true" Visible="false" Checked="false"
                                                Text="" OnCheckedChanged="cbBarkodHemenEkle_CheckedChanged" />
                                        </td>
                                        </tr>
                                        </table>
                                        </td>
                                        <td align="left" style="width: 90px">
                                            <asp:RadioButton ID="rbMalzemeKodunaGore" runat="server" AutoPostBack="true" Visible="false"
                                                GroupName="grpArama" Text="" OnCheckedChanged="rbAramaSecimleri_CheckedChanged" />
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td align="left" style="width: 252px">
                                            <asp:TextBox ID="txtArama" runat="server" Width="238px" AutoPostBack="false"
                                        ...
                                        <td align="left" style="width: 180px">
                                            <asp:Button ID="btnAra" runat="server" Text="Ara" Width="75px" OnClick="btnAra_Click" 
                                            BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" ForeColor="#6D8AAA" />
                                            &nbsp;
                                            <asp:Button ID="btnAramaTemizle" runat="server" OnClick="btnAramaTemizle_Click"
                                                Text="Temizle" Width="75px" BorderColor="#CCCCCC" 
                            ...
                            <tr>
                                <td align="left" style="width: 500px; padding: 5px;">
                                <div>
                                    <fieldset style="border: 1px solid #CCCCCC; width: 470px; margin: 0px 10px 0px 10px; border-radius: 5px; padding: 5px;">
                                    <legend style="font-size: 14px; font-family: Gisha; font-weight: bold; color: #EE7A0B">Açıklama Alanları</legend>
                                    <div style="width: 100%; text-align: center">
                                    &nbsp;<asp:TextBox runat="server" ID="txtSiparisAciklama1" ForeColor="#006699" BorderColor="#A3B5C9"
                                                BorderStyle="Solid" BorderWidth="1px" Width="450px" MaxLength="100"></asp:TextBox>
                                    <br />
                                    ...
                                    <asp:TextBox runat="server" ID="txtSiparisAciklama3" ForeColor="#006699" BorderColor="#A3B5C9"
                                                BorderStyle="Solid" BorderWidth="1px" Width="450px" MaxLength="100"></asp:TextBox>
                                    <%--<br />
                                    <asp:TextBox runat="server" ID="txtSiparisAciklama4" ForeColor="#006699" BorderColor="#A3B5C9"
                                                BorderStyle="Solid" BorderWidth="1px" Width="400px" MaxLength="200"></asp:TextBox>--%>
                                    </div>
                                    </fieldset>
                                </div>
                                </td>
                ...
                <tr>
                    <td style="width: 900px; height: 80px;" align="center" valign="top">
                    <table style="width: 900px; height: 80px;">
                    <tr>
                    <td align="left" valign="top" style="width: 202px; padding-left: 10px">
                        <table cellpadding="3" cellspacing="0"><tr><td>



                        <asp:Panel ID="pnlSepet" runat="server" Height="80px" Width="202px">
                        Aktivite No: <asp:Label ID="lblAktiviteID" runat="server" style="color: #D00000"></asp:Label>
                        <br />
                        <asp:ImageButton Width="130px" Height="50px" ImageUrl="img/sepet.png" runat="server" ID="ibSepetBuyut" OnClick="ibSepetBuyut_Click" />
                        <br />
                                ...
                                <table cellpadding="0" cellspacing="0" style="width: 165px; height: 200px; border: 1px solid #bfbfbf;
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td style="width: 25px; height: 25px; border-left: 1px solid #bfbfbf; border-top: 1px solid #bfbfbf;"
                                                        valign="middle" align="center">
                                                        <asp:TextBox ID="TextBox1" runat="server" ForeColor="#006699" BorderColor="#A3B5C9"
                                    ...
                                    <tr>
                                        <td align="center" colspan="2" style="border-bottom: 1px solid #bfbfbf; height: 15px">
                                            <span  style="font-weight: bold"><span id="Span5" runat="server" style="color: #C00000">
                                            <%# ((Sultanlar.WebUI.musteri.AktiviteListe)Session["Aktivite"])._AktiviteTipiID == 1 ? (Convert.ToDecimal(Eval("BRUT")) * ((100 + Convert.ToDecimal(Eval("KDV"))) / 100)).ToString("N3") : (Convert.ToDecimal(Sultanlar.DatabaseObject.Internet.Urunler.GetProductDiscountsAndPrice(Convert.ToInt32(Eval("UrunID")), 7)[4]) * ((100 + Convert.ToDecimal(Eval("KDV"))) / 100)).ToString("N3")%>
                                            </span> <span style="color: #C00000">TL</span></span>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <asp:DataList ID="dlListe" runat="server" Enabled="False">
                            <HeaderTemplate>
                                <table cellpadding="0" cellspacing="0" style="width: 850px;">
                                    <tr style="color: #D00000">
                                        <td align="center" style="width: 60px; height: 30px; border-bottom-style: solid; border-bottom-width: 1px;
                                            border-bottom-color: #BFBFBF; font-weight: bold">
                                            Ürt. Kod
                                        </td>
                                        <td align="center" style="width: 270px; height: 30px; border-bottom-style: solid; border-bottom-width: 1px;
                                            border-bottom-color: #BFBFBF; font-weight: bold">
                                            Ürün Adı
                                        </td>
                                        <td align="center" style="width: 40px; height: 30px; border-bottom-style: solid; border-bottom-width: 1px;
                                            border-bottom-color: #BFBFBF; font-weight: bold">
                                            Koli İçi
                                        </td>
                                        <td align="center" style="width: 60px; border-bottom-style: solid; border-bottom-width: 1px;
                                            border-bottom-color: #BFBFBF; font-weight: bold">
                                            Fiyat<br />KDV Dahil
                                        </td>
                                        ...
                                        <td align="center" style="width: 140px; border-bottom-style: solid; border-bottom-width: 1px;
                                            border-bottom-color: #BFBFBF; font-weight: bold">
                                            Tedarikçi
                                        </td>
                                        <td align="center" style="width: 140px; border-bottom-style: solid; border-bottom-width: 1px;
                            ...
                            <ItemTemplate>
                                <tr onmouseover="Satir(this,true)" onmouseout="Satir(this,false)">
                                    <td align="center" style="width: 60px; height: 30px; padding-left: 5px">
                                        <strong class="classurtkod" title='eskodlar.aspx?id=<%#Eval("UrunID") %>' style="cursor: pointer; color: #C10000"><span style="font-weight: bold"><%# Eval("URTKOD")%></span></strong>
                                    </td>
                                    <td align="left" style="width: 270px; height: 30px; padding-left: 5px">
                                        ...
                                        <span id="Span3" runat="server" style="color: Red; display: none"><%# Eval("UrunID") %></span>
                                    </td>
                                    <td align="center" style="width: 40px;">
                                        <strong><%#Eval("Adet") %></strong>
                                    </td>
                                    <td align="center" style="width: 60px;">
                                        <span style="font-weight: bold"><span id="Span2" runat="server" style="color: #C00000">
                                        <%# ((Sultanlar.WebUI.musteri.AktiviteListe)Session["Aktivite"])._AktiviteTipiID == 1 ? (Convert.ToDecimal(Eval("BRUT")) * ((100 + Convert.ToDecimal(Eval("KDV"))) / 100)).ToString("N3") : (Convert.ToDecimal(Sultanlar.DatabaseObject.Internet.Urunler.GetProductDiscountsAndPrice(Convert.ToInt32(Eval("UrunID")), ((Sultanlar.WebUI.musteri.AktiviteListe)Session["Aktivite"]).FiyatTipi /*7 yi aktivite ftipi yaptım*/ )[4]) * ((100 + Convert.ToDecimal(Eval("KDV"))) / 100)).ToString("N3")%>
                                        </span> <span style="color: #C00000">TL</span></span>
                                    </td>
                                    <td align="center" style="width: 35px;">
                                        <asp:TextBox ID="TextBox2" runat="server" ForeColor="#006699" BorderColor="#A3B5C9"
                                                BorderStyle="Solid" BorderWidth="1px" Width="25px" Height="20px" onkeypress="return isNumberKey(event)" onkeydown="return clickButton(event,'btnSipariseAktar')">
                                                </asp:TextBox>
                                    </td>
