<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="satisraporozet2.aspx.cs" Inherits="Sultanlar.WebUI.musteri.satisraporozet2" %>
...
<head runat="server">
    <title>Sultanlar : Satış Rapor Özet 2</title>
    ...
    <table cellpadding="0" cellspacing="0" style="width: 1000px; height: 400px; font-size: 10px; font-family: Verdana;
        ...
        <tr>
            ...
            <div class="Baslik">
                ...
                <td style="width: 100%">Satış Rapor Özeti 2<asp:Label runat="server" Width="30px"></asp:Label><input style="font-size: 10px; font-style: italic" type="button" value="Geri Dön" onclick="javascript:window.location.href='satisrapor.aspx'" /></td>
                </tr>
                </table>
                ...
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" 
                    DataSourceID="SqlDataSource1" ondatabound="ASPxGridView1_DataBound">
                ...
                SelectCommand="SELECT * FROM [zWeb-Satis-Rapor-Ozet-2] WHERE SATICI_KOD = @SLSREF">
                <SelectParameters>
