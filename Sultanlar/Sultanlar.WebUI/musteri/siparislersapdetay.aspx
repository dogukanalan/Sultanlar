<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="siparislersapdetay.aspx.cs" Inherits="Sultanlar.WebUI.musteri.siparislersapdetay" %>
...
<head runat="server">
    ...
    <title>Sultanlar : Sistemdeki Siparişler Detayı</title>
    ...
    <table cellpadding="0" cellspacing="0" style="width: 1000px; height: 400px; font-size: 10px; font-family: Verdana;
        ...
        <tr>
            ...
            <div class="Baslik">
                ...
                <td style="width: 100%">Sistemdeki Siparişler Detayı<asp:Label runat="server" Width="30px"></asp:Label><input style="font-size: 10px; font-style: italic" type="button" value="Siparişler" onclick="javascript:window.location.href='siparisler.aspx'" /><input style="font-size: 10px; font-style: italic" type="button" value="Sistemdeki Siparişler" onclick="javascript:window.location.href='siparislersap.aspx'" /></td>
                </tr>
                </table>
                ...
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" 
                    ...
                    <dx:ASPxSummaryItem FieldName="Net" ShowInGroupFooterColumn="Net" 
                        SummaryType="Sum" ValueDisplayFormat="N2" DisplayFormat="{0}" />
                ...
                SelectCommand="SELECT [SAP_SIPARIS_DETAY].[Vbeln] AS [Sip.No],[Erdat] AS [Tarih],[OName1] AS [Ana Cari],[Name1] AS [Cari],[SAP_SIPARIS_DETAY].[Vtext2] AS [Bölüm],[Matnr] AS [Mal.Kod],[Arktx] AS [Malzeme],[SAP_SIPARIS_DETAY].[Burut] AS [Brüt],[SAP_SIPARIS_DETAY].[Isk] AS [İsk],[SAP_SIPARIS_DETAY].[Net],[SAP_SIPARIS_DETAY].[Koli] FROM [SAP_SIPARIS_DETAY] INNER JOIN SAP_SIPARIS_BASLIK ON [SAP_SIPARIS_DETAY].Vbeln = SAP_SIPARIS_BASLIK.Vbeln WHERE YEAR([Erdat]) = 2017 AND [Matnr] != 0 AND [Sipalan Kod] = @SLSREF ORDER BY Erdat DESC">
                <SelectParameters>
