<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sifirlama.aspx.cs" Inherits="Sultanlar.WebUI.musteri.sifirlama" %>
...
<head id="Head1" runat="server">
    ...
    <title>Sultanlar : Şifre Sıfırlama</title>
...
<body style="margin: 0 0 0 0; background-color: #EFEEEA;">
    <form id="form1" runat="server" action="sifirlama.html">
    ...
    <table cellpadding="0" cellspacing="0" style="width: 100%"><tr>
     ...
     <div id="kompile" style="width: 400px; margin-top: 28px; border: 1px solid #E5E5E5; background-image: url('img/bg-giris-div.png'); background-repeat: repeat; 
         font-family: Tahoma; text-align: left; border-radius: 5px">
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td style="width: 400px; padding: 20px 20px 20px 20px">
                    <table cellpadding="0" cellspacing="0" style="width: 100%">
                        <tr>
                            <td style="font-size: 17px; color: #26238C; text-align: left; padding-left: 5px">Şifre sıfırlama</td>
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td style="width: 400px; padding: 0px 20px 2px 20px">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                        ...
                        ErrorMessage="Eposta formatı yanlış." Font-Size="10px" ForeColor="#D34836" 
                        ToolTip="Format yanlış" 
                        ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" 
                        ValidationGroup="vgSifirlama">*</asp:RegularExpressionValidator>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                        ControlToValidate="txtEposta" Display="Dynamic" 
                        ErrorMessage="Eposta gereklidir." Font-Size="10px" ForeColor="#D34836" 
                        ToolTip="Gerekli alan" ValidationGroup="vgSifirlama">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td style="width: 400px; padding: 0px 36px 20px 20px">
            ...
            <tr>
                <td style="width: 400px; padding: 0px 20px 20px 20px">
                    <table cellpading="0" cellspacing="0" style="width: 100%; padding-left: 3px">
                        <tr>
                            ...
                            <td style="text-align: right">
                                <asp:Button ID="btnGonder" runat="server" 
                                     class="sul-button sul-button-red" style="border: solid 1px #D34836; background-color: #DD4B39; color: #FFFFFF; font-weight: bold; width: 150px; height: 30px; border-radius: 5px"
                                    Text="Gönder" ValidationGroup="vgSifirlama" OnClick="btnGonder_Click" />
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <asp:Panel runat="server" ID="Panel2" Width="100%" Visible="false">
                    <div style="background-position: center center; padding: 10px 10px 10px 10px;">
    <table cellpadding="10" cellspacing="0" 
            style="border: 1px solid #CCCCCC; font-family: Verdana; font-size: 11px; width: 500px; text-align: left; 
            margin-top: 20px; height: 40px;background-image: url('img/bg-giris-div.png'); background-repeat: repeat; border-radius: 5px; padding: 5px;"><tr><td valign="top" 
                
                style="padding-left: 20px; color: #4C4C4C;">
            En kısa zamanda yeni şifreniz eposta adresinize gönderilecektir.
            <br />
            <br />
            Ana sayfaya dönmek için <a href="giris.html">tıklayınız.</a></td></tr></table><br /></div>
                </asp:Panel>
    ...
    <table cellpadding="10" cellspacing="0" 
            ...
            margin-top: 20px; height: 40px; background-image: url('img/bg-giris-div.png'); background-repeat: repeat; border-radius: 5px; padding: 5px;"><tr><td valign="top" 
                ...
                style="padding-left: 20px; color: #4C4C4C;">
            Girilen eposta adresine ait bir kayıt bulunamadı.
            <br />
            <br />
            Tekrar denemek için <a href="sifirlama.html">tıklayınız.</a></td></tr></table><br /></div>
                </asp:Panel>
    ...
    <table cellpadding="10" cellspacing="0" 
            ...
            margin-top: 20px; height: 40px; background-image: url('img/bg-giris-div.png'); background-repeat: repeat; border-radius: 5px; padding: 5px;"><tr><td valign="top" 
                ...
                style="padding-left: 20px; color: #4C4C4C;">
            Kısa bir süre önce bu eposta adresine ait bir şifre sıfırlama talebi bulunmaktadır, talebiniz yanıtlanana kadar maalesef tekrar şifre sıfırlama yapamazsınız.
            <br />
            <br />
            Ana sayfaya dönmek için <a href="giris.html">tıklayınız.</a></td></tr></table><br /></div>
                </asp:Panel>
    ...
    <table cellpadding="10" cellspacing="0" 
            ...
            margin-top: 20px; height: 40px; background-image: url('img/bg-giris-div.png'); background-repeat: repeat; border-radius: 5px; padding: 5px;"><tr><td valign="top" 
                ...
                style="padding-left: 20px; color: #4C4C4C;">
            Üyeliğiniz pasife alınmış durumdadır. Ayrıntılar için lütfen telefon ile bilgi alınız.
            <br />
            <br />
            Ana sayfaya dönmek için <a href="giris.html">tıklayınız.</a></td></tr></table><br /></div>
                </asp:Panel>
