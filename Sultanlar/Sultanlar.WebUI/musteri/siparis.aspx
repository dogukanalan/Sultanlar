<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="siparis.aspx.cs" Inherits="Sultanlar.WebUI.musteri.siparis" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #FFFFFF">
    ...
    <script type="text/javascript">
        Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(function (evt, args) {
            ...
            //            $('#txtSiparisAciklama3').blur(function () {
            //                var s = $('#txtSiparisAciklama3').val();
            ...
            //                    $('#txtSiparisAciklama3').val(output);
            //                }
            //            });
    ...
    <div id="tiptip_arrow_inner"></div>
            ...
            <div runat="server" id="divKampanyaMiktarDegismez" style="position: absolute; width: 300px; height: 100px; z-index: 5; left: 320px;
                ...
                <td align="center" valign="middle">
                    ...
                    <asp:Button ID="lbKampanyaMiktarDegismez" runat="server" style="font-family: Tahoma; font-size: 10px" OnClick="lbKampanyaMiktarDegismez_Click" Font-Underline="false" Text="Kapat" />
                </td>
                </tr>
                </table>
            </div>
            ...
            <div runat="server" id="divFiyatTipiDegisme" style="position: absolute; width: 300px; height: 100px; z-index: 5; left: 320px;
                top: 231px;" visible="false">
                <div style="position: fixed; width: 100%; height: 100%; z-index: -1; left: 0; top: 0;
                filter: alpha(opacity=60); -moz-opacity: .60; opacity: .60; background-color: #000000">
                </div>
                ...
                <tr>
                <td align="center" valign="middle">
                    <br /><strong>UYARI</strong><br /><br />
                    Fiyat tipi değiştiğinde, siparişteki ürünlerin fiyatları değişecektir ve siparişteki kampanyalar silinecektir.<br /><br />
                    Devam etmek istiyor musunuz?<br /><br />
                    <asp:Button runat="server" ID="btnFiyatTipiDegismeDevam" Text="Evet" Width="50px" OnClick="btnFiyatTipiDegismeDevam_Click" 
                        BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" ForeColor="#6D8AAA" />
                    <asp:Button runat="server" ID="btnFiyatTipiDegismeDur" Text="Hayır" Width="50px" OnClick="btnFiyatTipiDegismeDur_Click" 
                        BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" ForeColor="#6D8AAA" /><br /><br />
                </td>
                </tr>
                </table>
            </div>
            ...
            <div style="position: absolute; width: 800px; z-index: 4; left: 100px; background-color: #ffffff;
                ...
                <td style="padding-left: 50px">
                    Barkod Arama:
                    <asp:TextBox ID="txtOneriBarkod" runat="server" Width="155px" AutoPostBack="false"
                        ForeColor="#006699" BorderColor="#A3B5C9" style="padding: 3px 3px 3px 3px;"
                        BorderStyle="Solid" BorderWidth="1px" OnTextChanged="txtOneriBarkod_TextChanged"></asp:TextBox>
                </td>
                <td>
                    <asp:Label runat="server" ID="lblOneriBarkod"></asp:Label>
                </td>
                </tr>
                <tr>
                <td></td>
                <td>
                    <asp:RadioButton runat="server" ID="rbOneriTumu" Text="Tümü" GroupName="rbOneri" AutoPostBack="true" Checked="true" OnCheckedChanged="rbOneri_CheckedChanged" />
                    <asp:RadioButton runat="server" ID="rbOneriSecili" Text="Seçilenler" GroupName="rbOneri" AutoPostBack="true" OnCheckedChanged="rbOneri_CheckedChanged" />
                    <asp:RadioButton runat="server" ID="rbOneriSecimsiz" Text="Seçilmeyenler" GroupName="rbOneri" AutoPostBack="true" OnCheckedChanged="rbOneri_CheckedChanged" />
                </td>
                </tr>
                </table>
                <table width="780px" cellpadding="10" cellspacing="0" style="font-family: Tahoma; font-size: 11px; height: 40px">
                    <tr style="color: #C00000">
                        <td style="width: 260px; font-size:12px; padding-left: 70px">
                            Ürün
                        </td>
                        <td align="center" style="width: 80px; font-size:12px">
                            Koli Ad.
                        </td>
                        <td align="left" style="width: 50px; font-size:12px">
                            Adet
                        </td>
                        <%--<td align="center" style="width: 80px; font-size:12px">
                            Fiyat
                        ...
                        <tr style="background-color: #E8E8E8">
                            ...
                            <td align="center" style="width: 50px;">
                                ...
                                <input type="text" id="Miktar" runat="server" value='' onkeypress="return isNumberKey(event)"
                                    style="width: 35px; color: #006699; border: 1px solid #A3B5C9;" />
                            </td>
                            <%--<td align="right" style="width: 80px;">
                                <%#Eval("BirimFiyat") != DBNull.Value ? Convert.ToDecimal(Eval("BirimFiyat")).ToString("N2") + "TL" : "-Fiyat Yok-"%>
                            </td>--%>
                            <td align="center" style="width: 80px;">
                            ...
                            <td align="center" style="width: 30px;">
                                <asp:CheckBox runat="server" Enabled="false" Checked='<%#Convert.ToBoolean(Eval("Secili"))%>' />
                            </td>
                        </tr>
                    </ItemTemplate>
                ...
                <td valign="middle" align="center">
                    <table cellpadding="0" cellspacing="0" style="width: 100%">
                    <tr>
                    <td align="left"><asp:ImageButton Visible="false" ID="ibOneriSiparisiOnceki" runat="server" ImageUrl="img/sol_ok.gif" onclick="ibOneriSiparisiOnceki_Click" /></td>
                    <td align="center"><asp:Label Visible="false" runat="server" ID="lblOneriSiparisiKacinci"></asp:Label><asp:Label runat="server" ID="lblOneriSiparisiSayisi"></asp:Label></td>
                    <td align="right"><asp:ImageButton Visible="false" ID="ibOneriSiparisiSonraki" runat="server" ImageUrl="img/sag_ok.gif" onclick="ibOneriSiparisiSonraki_Click" /></td>
                    </tr>
                    </table>
                </td>
                </tr>
            ...
            <div style="position: absolute; width: 300px; height: 100px; z-index: 4; left: 320px;
                ...
                <tr>
                <td align="center" valign="middle">
                    Bir siparişe en fazla 100 kalem ürün girebilirsiniz. Ürün eklemek için yeni bir sipariş açıp devam edebilirsiniz.<br /><br />
            ...
            <div style="width: 100%; height: 100%; background-color: #ffffff; border: 1px solid #D1D1D1; border-radius: 5px; padding: 5px; margin-bottom: 20px;">
                <table cellpadding="10" cellspacing="0" style="font-family: Tahoma; width: 780px; height: 40px">
                <tr>
                <td valign="middle">
                ...
                <table width="780px" cellpadding="5" cellspacing="0" style="font-family: Tahoma; font-size: 11px; height: 40px">
                    <tr style="color: #C00000">
                        <td style="width: 10px;">
                        ...
                        <td align="center" style="width: 130px; font-size:12px">
                            Miktar
                        </td>
                        <td align="center" style="width: 80px; font-size:12px">
                            Fiyat
                ...
                <asp:Repeater ID="Repeater1" runat="server" onitemcommand="Repeater1_ItemCommand">
                    <HeaderTemplate>
                        <table width="780px" cellpadding="5" cellspacing="0" style="font-family: Tahoma; font-size: 11px">
                    </HeaderTemplate>
                    <ItemTemplate>
                        <tr style="background-color: #E8E8E8">
                            ...
                            <td align="center" style="width: 130px;">
                                <asp:Button Width="25px" Height="25px" runat="server" Text="+" CommandName="Arttir" BorderColor="#FFFFFF" BorderStyle="Solid" BorderWidth="1px" ForeColor="#FFFFFF" Font-Size="12px" Font-Bold="true" BackColor="SlateGray" Visible='<%#!Convert.ToBoolean(Eval("KampanyaHediye"))%>'></asp:Button><asp:Label runat="server" Width="25px" Visible='<%#Convert.ToBoolean(Eval("KampanyaHediye"))%>'></asp:Label>
                                ...
                                <asp:Button Width="25px" Height="25px" runat="server" Text="-" CommandName="Azalt" BorderColor="#FFFFFF" BorderStyle="Solid" BorderWidth="1px" ForeColor="#FFFFFF" Font-Size="12px" Font-Bold="true" BackColor="SlateGray" Visible='<%#!Convert.ToBoolean(Eval("KampanyaHediye"))%>'></asp:Button><asp:Label runat="server" Width="25px" Visible='<%#Convert.ToBoolean(Eval("KampanyaHediye"))%>'></asp:Label>
                            </td>
                            <td align="right" style="width: 80px;">
                                <input type="hidden" value='<%#Eval("BirimFiyat")%>' id="BirimFiyat" runat="server" />
                            ...
                            <td align="center" style="width: 40px;">
                                <%# Sultanlar.DatabaseObject.Internet.Urunler.GetProductVade(Convert.ToInt32(Eval("UrunID")), Sultanlar.DatabaseObject.Internet.Siparisler.GetObjectsBySiparisID(Sultanlar.DatabaseObject.Internet.SiparislerDetay.GetObjectBySiparislerDetayID(Convert.ToInt64(Eval("SiparisDetayID"))).intSiparisID).sintFiyatTipiID) %>
                            </td>
                            <td align="right" style="width: 80px;">
                            ...
                            <td align="center" style="width: 60px;">
                                <%#Convert.ToDouble(Eval("KOLIDONUSUM")).ToString("N1")%>
                            </td>
                ...
                <td align="right" valign="middle">Sip.Top.: </td>
                </tr>
                </table>
                </td>
                <td valign="middle" align="left" style="width: 160px"><asp:Label runat="server" ID="lblSepetToplam" Font-Bold="true" /></td>
                </tr>
                </table>
            </div>
            </div>
            ...
            <table cellpadding="0" cellspacing="0" style="width: 1000px; margin-top: 5px;">
                <tr>
                    ...
                    <td style="width: 170px; text-align: left; font-size: 12px">
                        <%--<asp:LinkButton runat="server" ID="lbOneriSiparisi" Text="Öneri Siparişi Oluştur" OnClick="lbOneriSiparisi_Click" Visible='<%#Convert.ToBoolean(((Sultanlar.DatabaseObject.Internet.Musteriler)Session["Musteri"]).tintUyeTipiID != 5)%>'></asp:LinkButton>--%>
                            ...
                            <tr>
                                ...
                                <td style="width: 256px; text-align: center">
                                    <asp:DropDownList ID="ddlTaksitPlanlari" runat="server" AutoPostBack="True" 
                                                    Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Size="9px" 
                                                    Font-Strikeout="False" Font-Underline="False" ToolTip="Taksit Planları" class="kucukbilgiGoster"
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td align="left" style="width: 400px">
                                            <asp:TextBox ID="txtArama" runat="server" Width="340px" AutoPostBack="false"
                                            ...
                                            <asp:TextBox ID="txtAramaMiktar" runat="server" Width="26px" AutoPostBack="false" Enabled="false"
                                            ForeColor="#006699" BorderColor="#A3B5C9" style="padding: 3px 3px 3px 3px;"
                                            BorderStyle="Solid" BorderWidth="1px" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                        </td>
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td style="width: 25px; height: 30px; border-left: 1px solid #bfbfbf;"
                                                        ...
                                                        <span runat="server" style="color: Red; visibility: collapse"><%# Eval("UrunID") %></span>
                                                        <asp:ImageButton runat="server" CommandArgument='<%#Eval("UrunID")%>' ToolTip="Kampanyalı Ürün" ImageUrl="img/gul.png" Visible='<%#Convert.ToBoolean(Convert.ToInt32(Eval("KamKartRefSayisi")) > 0)%>' OnClick="KampanyaliUrun_Click" class="kucukbilgiGoster" />
                            ...
                            <ItemTemplate>
                                <tr onmouseover="Satir(this,true)" onmouseout="Satir(this,false)">
                                    ...
                                    <td align="left" style="width: 255px; padding-left: 5px">
                                        ...
                                        <input type="hidden" value='<%#Eval("pkResimID") %>' id="ResimID" runat="server" />
                                        <input type="hidden" value='<%#Eval("UrunID") %>' id="UrunID" runat="server" />
                                        <strong class="classurtkod" title='olcu.aspx?id=<%#Eval("UrunID") %>' style="cursor: pointer; color: #C10000">[ÖLÇÜLER]</strong>
                                        <asp:LinkButton runat="server" Text='<%# Eval("Ad") %>' OnClick="lbUrunAyrinti_Click" />
