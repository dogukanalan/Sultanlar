<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="satisraporkarsilastirma3.aspx.cs" Inherits="Sultanlar.WebUI.musteri.satisraporkarsilastirma3" %>
...
<head>
    <title>Sultanlar : Satış Rapor Karşılaştırma 2</title>
    ...
    <table cellpadding="0" cellspacing="0" style="width: 1000px; height: 400px; font-size: 10px; font-family: Verdana;
        ...
        <tr>
            ...
            <div class="Baslik">
                ...
                <td style="width: 100%">Satış Rapor Karşılaştırma 3<asp:Label runat="server" Width="30px"></asp:Label><input style="font-size: 10px; font-style: italic" type="button" value="Geri Dön" onclick="javascript:window.location.href='satisrapor.aspx'" /></td>
                </tr>
                </table>
                ...
                SelectCommand="SELECT * FROM [zWeb-Satis-Rapor-Karsilastirma-3] WHERE SATICI_KOD = @SLSREF">
                <SelectParameters>
