<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucKampanyaAyrinti.ascx.cs" Inherits="Sultanlar.WebUI.musteri.ucKampanyaAyrinti" %>
...
<div style="font-size: 10px; font-family: Tahoma; width: 850px">
    <div style="width: 850px; text-align: right; padding: 10px 10px 10px 10px">
                Adet: <asp:TextBox runat="server" ID="txtMiktar" Width="30px" onkeypress="return isNumberKey(event)"
                ForeColor="#006699" BorderColor="#A3B5C9" BorderStyle="Solid" BorderWidth="1px" onkeydown="return clickButton(event,'ucKampanyalar1_ucKampanyaAyrinti1_btnSiparisVer')"></asp:TextBox>
                <asp:Label runat="server" Width="20px" ID="lblAralikBuyukluk"></asp:Label>
                <asp:Button runat="server" ID="btnSiparisVer" Text="Siparişe Aktar" 
                    onclick="btnSiparisVer_Click" BorderColor="#CCCCCC" BorderStyle="Solid" 
