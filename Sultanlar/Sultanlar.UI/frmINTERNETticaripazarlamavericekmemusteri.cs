    ...
    public partial class frmINTERNETticaripazarlamavericekmemusteri : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (comboBox1.SelectedIndex > -1)
            {
                ...
                {
                    MessageBox.Show(muskod + " müşteri kodu başka bir müşteriye ait!", "Başarılı", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                    return;
                }

                if (MessageBox.Show("Kayıtlı olan\r\n\r\nKod: " + ch.MUSKOD + "\r\nCari: " + ch.MUSTERI + "\r\n\r\nnoktası\r\n\r\nKod: " + muskod + "\r\nCari: " + yeninoktaadi + "\r\n\r\nnoktası ile eşleşecektir.\r\nDevam etmek istediğinize emin misiniz?", "Alt cari eşleştirme", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == System.Windows.Forms.DialogResult.Yes)
                {
