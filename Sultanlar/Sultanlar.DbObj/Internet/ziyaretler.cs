...
namespace Sultanlar.DbObj.Internet
{
    public class ziyaretler : DbObj
    {
        ...
        public ziyaretler(int MTIP, int RUT_TUR, string RUT_ID, int GMREF, int SMREF, int SLSREF, string BARKOD, DateTime ZIY_BAS_TAR, DateTime ZIY_BIT_TAR, int ZIY_NDN_ID, string ZIY_KONUM, string ZIY_KONUM_ADRES, string ZIY_KONUM_CIKIS, string ZIY_KONUM_ADRES_CIKIS, int FARK_KNM_ZIY, byte[] ZIY_KONUM_RESIM, string ZIY_NOTLARI, int ZIY_SIP, int ZIY_AKT, int ZIY_IAD, int ZIY_TAH)
        {
            this.MTIP = MTIP;
        ...
        {
            Dictionary<string, object> param = new Dictionary<string, object>() { { "MTIP", MTIP }, { "RUT_TUR", RUT_TUR }, { "RUT_ID", RUT_ID }, { "GMREF", GMREF }, { "SMREF", SMREF }, { "SLSREF", SLSREF }, { "BARKOD", BARKOD }, { "ZIY_BAS_TAR", ZIY_BAS_TAR }, { "ZIY_BIT_TAR", ZIY_BIT_TAR }, { "ZIY_NDN_ID", ZIY_NDN_ID }, { "ZIY_KONUM", ZIY_KONUM }, { "ZIY_KONUM_ADRES", ZIY_KONUM_ADRES }, { "ZIY_KONUM_CIKIS", ZIY_KONUM_CIKIS }, { "ZIY_KONUM_ADRES_CIKIS", ZIY_KONUM_ADRES_CIKIS }, { "FARK_KNM_ZIY", FARK_KNM_ZIY }, { "ZIY_KONUM_RESIM", ZIY_KONUM_RESIM }, { "ZIY_NOTLARI", ZIY_NOTLARI }, { "ZIY_SIP", ZIY_SIP }, { "ZIY_AKT", ZIY_AKT }, { "ZIY_IAD", ZIY_IAD }, { "ZIY_TAH", ZIY_TAH } };
