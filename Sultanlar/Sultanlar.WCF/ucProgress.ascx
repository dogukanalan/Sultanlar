<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucProgress.ascx.cs" Inherits="Sultanlar.WCF.ucProgress" %>


        <div id="divProgress">
            <div style="padding-top: 50px; filter: alpha(opacity=40); -moz-opacity: .60; opacity: .60;
                background-color: #000000; position: fixed; width: 100%; height: 100%; z-index: 9;
                left: 0; top: 0;">
            </div>
            <div style="padding-top: 50px; position: fixed; width: 100%; height: 100%; z-index: 10;
                left: 0; top: 0;">
